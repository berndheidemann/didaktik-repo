...
**Parsons Problems.** Code-Snippets in korrekte Reihenfolge bringen. Empirisch sehr gut belegt (Ericson et al. 2022, Systematic Literature Review mit 677 nach Deduplication identifizierten Studien, daraus Endbestand der inkludierten Arbeiten): **gleiche Lernergebnisse wie freies Schreiben bei deutlich reduziertem Zeitaufwand und geringerer kognitiver Last**. Ideale Zwischenstufe im Fading-Pfad zwischen Worked Example und freiem Code. In React mit drag-and-drop in einem Tag baubar.
