...
**Parsons Problems.** Code-Snippets in korrekte Reihenfolge bringen. Empirisch sehr gut belegt (Ericson et al. 2022, Meta-Review über 677 Arbeiten): **gleiche Lernergebnisse wie freies Schreiben bei deutlich reduziertem Zeitaufwand und geringerer kognitiver Last**. Ideale Zwischenstufe im Fading-Pfad zwischen Worked Example und freiem Code. In React mit drag-and-drop in einem Tag baubar.
